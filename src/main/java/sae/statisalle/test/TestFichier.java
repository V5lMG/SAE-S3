...
class TestFichier {
    ...
    void contenuFichier() {
        ...
        assertEquals(2, contenu.length, "Le fichier devrait contenir deux lignes.");
        assertEquals("Nom,Prenom,Telephone", contenu[0], "La première ligne doit correspondre à l'en-tête attendu.");
    }
